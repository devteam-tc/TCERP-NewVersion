...
const ProductPage = ( {breadcrumbTitle}  ) => {
  ...
  // ✅ Function to generate FAQ structured data safely
  ...
  const breadcrumbs = [
    { label: 'Home', link: '/' },
    { label: 'Tech Cloud ERP', link: null }
  ];
  ...
  <li key={cat.href}>
    <a
      ...
      onClick={(e) => {
        e.preventDefault(); // Optional: only if you're using a SPA-style approach
