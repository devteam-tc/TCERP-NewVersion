...
export const productDetailsData = {
  'tech-cloud-erp': {
    sidebar: {
      // categories remain same for all
      categories: [
    ...
    content: {
      ...
      heading: "The Executive Search Process for Optimal Results",
      paragraphs: [
        "The executive search process is meticulously designed to identify and attract top-tier leadership talent that aligns with an organization’s strategic goals.",
        "It begins with a thorough understanding of the company’s needs, culture, and long-term vision, ensuring that the search is precisely targeted.",
        "Leveraging an extensive network and advanced assessment tools, executive search firms meticulously evaluate candidates’ qualifications, experience, and leadership capabilities.",
      ],
  ...
  "customer-relationship-management": {
    ...
    content: {
      ...
      heading: "Unlocking Your Team's Potential with Effective Training Sessions",
      paragraphs: [
  ...
  "point-of-sale": {
    ...
    content: {
      subTitle: "POS Session",
      heading: "Unlocking Your Team's Potential with Effective POS Session ",
      paragraphs: [
        "Effective training sessions are a crucial component of any organization’s growth strategy, as they equip employees with the skills and knowledge necessary to excel in their roles.",
        "Our training sessions are designed to be engaging, interactive, and tailored to meet the unique needs of your team.",
        "From leadership development to technical skills training, our expert trainers will work with you to create a customized training program that drives real results.",
  ...
  "Ecommerce-software":{
    ...
    content: {
      subTitle: "Ecommerce Session",
      heading: "Unlocking Your Team's Potential with Effective Ecommerce Session ",
      paragraphs: [
        "Effective training sessions are a crucial component of any organization’s growth strategy, as they equip employees with the skills and knowledge necessary to excel in their roles.",
        "Our training sessions are designed to be engaging, interactive, and tailored to meet the unique needs of your team.",
        "From leadership development to technical skills training, our expert trainers will work with you to create a customized training program that drives real results.",
