...
// const DownloadFormPopup = ({ show, onHide, industryTitle }) => {
...
//       // Store that user has submitted
//       localStorage.setItem('tcerp_first_submission_done', 'true');
      
//       // Close popup and trigger download
//       onHide();
//     } catch (err) {
...
//         <h3 className="mb-4">Download {industryTitle} Brochure</h3>
//         <p className="mb-4">Please fill out this form to download the brochure.</p>
