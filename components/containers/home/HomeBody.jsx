      ...
      <Link href="/demo" className="gradient-btn">Get an Industry Specific Demo</Link>
        ...
        <div className="banner-cards-container">
            <div className="card-item" 
              ...
              <Image src="/images/banner/new/chart1.webp" alt="Chart 1" width={200} height={200} />
            </div>
            <div className="card-item" 
              onClick={(e) => e.currentTarget.classList.add('clicked')}
              onMouseLeave={(e) => e.currentTarget.classList.remove('clicked')}>
              <Image src="/images/banner/new/chart2.webp" alt="Chart 2" width={200} height={200} />
            </div>
            {/* <div className="card-item" 
              onClick={(e) => e.currentTarget.classList.add('clicked')}
              onMouseLeave={(e) => e.currentTarget.classList.remove('clicked')}>
              <Image src="/images/banner/new/chart3.webp" alt="Chart 3" width={200} height={200} />
            </div> */}
            <div className="card-item"  
              onClick={(e) => e.currentTarget.classList.add('clicked')}
              onMouseLeave={(e) => e.currentTarget.classList.remove('clicked')}>
              <Image src="/images/banner/new/chart4.webp" alt="Chart 4" width={200} height={200} />
            </div>
            <div className="card-item" 
              onClick={(e) => e.currentTarget.classList.add('clicked')}
              onMouseLeave={(e) => e.currentTarget.classList.remove('clicked')}>
              <Image src="/images/banner/new/chart5.webp" alt="Chart 5" width={200} height={200} />
            </div>
            <div className="card-item" 
              onClick={(e) => e.currentTarget.classList.add('clicked')}
              onMouseLeave={(e) => e.currentTarget.classList.remove('clicked')}>
              <Image src="/images/banner/new/chart6.webp" alt="Chart 6" width={200} height={200} />
            </div>
        </div>
    </div>
    );
