...
const Banner = () => (
  <section className="banner-hero">
    ...
    <div className="banner-center-content">
      ...
      <p className='mb-5' style={{  color: '#ef5226' , fontWeight: '600'}} >We don’t just sell software — we tailor it to your business.</p>
      ...
      <div className="rocket-visual">
        ...
        <div className="chart-card chart-top-left">
          <Image src="/images/banner/Chart1.webp" alt="Chart 1" width={380} height={180} />
        </div>
        <div className="chart-card chart-top-right">
          <Image src="/images/banner/Chart2.webp" alt="Chart 2" width={380} height={180} />
        </div>
        <div className="chart-card chart-bottom-left">
          <Image src="/images/banner/Chart3.webp" alt="Chart 3" width={380} height={180} />
        </div>
        <div className="chart-card chart-bottom-right">
          <Image src="/images/banner/Chart4.webp" alt="Chart 4" width={380} height={180} />
        </div>
        {/* Rocket */}
        <div className="rocket-center">
          <Image src="/images/banner/icons/rocket.png" alt="Rocket" width={480} height={350} />
        </div>
        {/* Floating Icons */}
        {[1,2,3,4,5,6].map(num => {
