              ...
              <div className="accordionItem active">
                ...
                <div className="conteBox">
                  <div className="box">
                    ...
                    Grow your brand online with smart strategies that attract, engage and convert. We make marketing simple and effective.
                    </p>
              ...
              <div className="accordionItem">
                ...
                <div className="conteBox">
                  <div className="box">
                    ...
                    <p className="pra fs-seven mb-xxl-4 mb-xl-3 mb-2 pb-xxl-1">
                    We build fast, responsive and stunning websites that help your business stand out and grow online.
                    </p>
              ...
              <div className="accordionItem">
                ...
                <div className="conteBox">
                  <div className="box">
                    ...
                    <p className="pra fs-seven mb-xxl-4 mb-xl-3 mb-2 pb-xxl-1">
                    We build smooth, user-friendly apps that bring your ideas to life and keep users coming back for more.
                    </p>
