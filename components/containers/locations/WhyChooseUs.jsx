...
UAE: [
  {   icon: <img src="/images/location/UAE/UnifiedBusiness.svg" alt="Streamlined Business Workflows" />, 
    ...
    dubai: [
      {
        icon: <img src="/images/location/Dubai/Intelligent Business Automation.svg" alt="Streamlined Business Workflows" />,
        title: 'Intelligent Business Automation',
        description: 'Automate repetitive tasks, streamline workflows, and enhance productivity across departments.'
      },
      {
        icon: <img src="/images/location/Dubai/Modular ERP Solutions.svg" alt="Industry Modules" />,
        title: 'Modular ERP Solutions',
        description: 'Deploy modules tailored for finance, HR, inventory, and other operational needs.'
      },
      {
        icon: <img src="/images/location/Dubai/Cloud & On-Premise Flexibility.svg" alt="Deployment Options" />,
        title: 'Cloud & On-Premise Flexibility',
        description: 'Adopt deployment methods that match your IT infrastructure and growth strategy.'
      },
      {
        icon: <img src="/images/location/Dubai/Actionable Analytics.svg" alt="Analytics & Reports" />,
        title: 'Actionable Analytics',
        description: 'Transform operational data into insights with real-time dashboards and reporting tools.'
      },
      {
        icon: <img src="/images/location/Dubai/Unified Software Ecosystem.svg" alt="System Integration" />,
        title: 'Unified Software Ecosystem',
        description: 'Ensure smooth operations by connecting ERP with existing applications and systems.'
      },
      {
        icon: <img src="/images/location/Dubai/Expert Technical Assistance.svg" alt="Dedicated ERP Support" />,
        title: 'Expert Technical Assistance',
        description: 'Receive prompt support and guidance to optimize your ERP system’s performance.'
      },
    ],
     abudhabi: [
      {
        icon: <img src="/images/location/abudhabi/Streamlined Enterprise Management.svg" alt="Streamlined Business Workflows" />,
        title: 'Streamlined Enterprise Management',
        description: 'Enhance operational efficiency by centralizing workflows and automating routine business processes.'
      },
      {
        icon: <img src="/images/location/abudhabi/Industry-Oriented Modules.svg" alt="Industry Modules" />,
        title: 'Industry-Oriented Modules',
        description: 'Access specialized modules for finance, supply chain, HR, and sales to meet sector-specific needs.'
      },
      {
        icon: <img src="/images/location/abudhabi/Flexible ERP Deployment.svg" alt="Flexible ERP Deployment" />,
        title: 'Flexible ERP Deployment',
        description: 'Choose between cloud-based or on-premise solutions for secure, scalable business operations.'
      },
      {
        icon: <img src="/images/location/abudhabi/Data-Driven Insights.svg" alt="Data-Driven Insights" />,
        title: 'Data-Driven Insights',
        description: 'Use dashboards and advanced analytics to make smarter, faster business decisions.'
      },
      {
        icon: <img src="/images/location/abudhabi/Seamless System Integration.svg" alt="Seamless System Integration" />,
        title: 'Seamless System Integration',
        description: 'Integrate ERP with existing tools to unify operations and improve team collaboration.'
      },
      {
        icon: <img src="/images/location/abudhabi/Dedicated Support & Maintenance.svg" alt="Dedicated Support & Maintenance" />,
        title: 'Dedicated Support & Maintenance',
        description: 'Rely on expert assistance to keep your ERP running smoothly and your business uninterrupted.'
      },
    ],
     sharjah: [
      {
        icon: <img src="/images/location/sharjah/Efficient Business Workflows.svg" alt="Efficient Business Workflows" />,
        title: 'Efficient Business Workflows',
        description: 'Simplify and optimize operations to save time, reduce errors, and boost overall productivity.'
      },
      {
        icon: <img src="/images/location/sharjah/ Specialized ERP Modules.svg" alt=" Specialized ERP Modules" />,
        title: ' Specialized ERP Modules',
        description: 'Access modules designed for industry-specific functions, covering finance, HR, and inventory.'
      },
      {
        icon: <img src="/images/location/sharjah/Scalable ERP Deployment.svg" alt="Scalable ERP Deployment" />,
        title: 'Scalable ERP Deployment',
        description: 'Implement cloud or on-premise ERP solutions to suit your company’s infrastructure and growth plans.'
      },
      {
        icon: <img src="/images/location/sharjah/Insightful Business Intelligence.svg" alt="Insightful Business Intelligence" />,
        title: 'Insightful Business Intelligence',
        description: 'Leverage analytics tools and reports to track KPIs and improve decision-making.'
      },
      {
        icon: <img src="/images/location/sharjah/Integrated Operations Platform.svg" alt="Integrated Operations Platform" />,
        title: 'Integrated Operations Platform',
        description: 'Connect all business functions under one ERP system for seamless collaboration.'
      },
      {
        icon: <img src="/images/location/sharjah/Reliable Support Services.svg" alt="Reliable Support Services" />,
        title: 'Reliable Support Services',
        description: 'Benefit from continuous expert support to maintain optimal ERP performance.'
      },
    ],
     ajman: [
      {
        icon: <img src="/images/location/ajman/Modern ERP Management.svg" alt=" Modern ERP Management" />,
        title: 'Modern ERP Management',
        description: 'Enhance efficiency and automate complex workflows with advanced ERP solutions.'
      },
      {
        icon: <img src="/images/location/ajman/Industry-Focused Tools.svg" alt="Industry-Focused Tools" />,
        title: 'Industry-Focused Tools',
        description: 'Manage finance, inventory, HR, and operations with modules designed for your sector.'
      },
      {
        icon: <img src="/images/location/ajman/Deployment That Adapts.svg" alt="Deployment That Adapts" />,
        title: 'Deployment That Adapts',
        description: 'Choose cloud or on-site ERP setups that are secure, scalable, and flexible.'
      },
      {
        icon: <img src="/images/location/ajman/Analytical Insights & Dashboards.svg" alt="Analytical Insights & Dashboards" />,
        title: 'Analytical Insights & Dashboards',
        description: 'Access actionable insights from real-time data to make informed business decisions.'
      },
      {
        icon: <img src="/images/location/ajman/Seamless Integration Across Platforms.svg" alt="Seamless Integration Across Platforms" />,
        title: 'Seamless Integration Across Platforms',
        description: 'Ensure all your systems communicate efficiently, reducing errors and delays.'
      },
      {
        icon: <img src="/images/location/ajman/Proactive Support & Maintenance.svg" alt="Proactive Support & Maintenance" />,
        title: 'Proactive Support & Maintenance',
        description: 'Rely on expert teams for continuous maintenance, updates, and troubleshooting.'
      },
    ],
    bahrain: [
      { 
