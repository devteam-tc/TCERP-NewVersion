    ...
    <>
            ...
            <div className="row banner-row">
              <div className="col-lg-5 align-self-center">
                <div className="banner-text position-relative">
                  <h1 className="banner-title title-anim">
                    Make a <span className="d-lg-block">big impact</span> with IT
                  </h1>
                  ...
                  >
                    ...
                    <button
                      ...
                      className="video-rotate-btn border-0 vidplay position-absolute top-50 start-50 translate-middle"
                    >
              ...
              <div className="col-lg-7 align-self-center">
                <div className="banner-image custom-inner-hover ps-lg-5 position-relative">
                  ...
                  <Image
                    className="banner-shape-2 position-absolute"
                    src={bannerShape2}
                    alt="banner-shape-2"
                  />
                  <Image
                    className="banner-shape-3 position-absolute"
                    src={bannerShape3}
                    alt="banner-shape-3"
                  />
                </div>
      ...
      {videoActive && (
        ...
        >
          ...
          >
            <YouTubeEmbed embedId="0WC-tD-njcA" />
            <button
